    ...
    return (
        <div className="p-6">
            ...
            <div>
                ...
                <input type="text" className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" onChange={(e) => {setFirstName(e.target.value);}}/>

                <label className="block text-sm font-medium text-gray-700 mb-1">lastName</label>
                <input type="text" className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" onChange={(e) => {setLastName(e.target.value);}}/>

                <label className="block text-sm font-medium text-gray-700 mb-1">email</label>
                <input type="text" className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" onChange={(e) => {setEmail(e.target.value);}}/>
